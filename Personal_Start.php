  ...
  <div class="navbar">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="Personal/boka.php">Boka tid</a>
        </div>
      </div>
      <div class="dropdown">
        <button class="dropbtn">Recept</button>
        <div class="dropdown-content">
          <a href="Personal/nurseview.php">Förnya</a>
        </div>
      </div>
      <div class="dropdown">
        <button class="dropbtn">Övrigt</button>
        <div class="dropdown-content">
          <a href="Personal/boka.php">Besök</a>
          <a href="Personal/videoChatt_Personal.php">Videosamtal</a>
          <a href="Personal/videoChatt_Personal.php">Chat</a>
          <a href="Personal/diabetesdagbokvardpersonal.php">Diabetes Dagbok</a>
        </div>
      </div>
    ...
    <div class="main-menu">
      ...
      <div class="left-column">
        <button><a href="Personal/boka.php">Tidsbokning</a></button>
        <button><a href="Personal/diabetesdagbokvardpersonal.php">Diabetesdagbok</a></button>
      </div>
      <div class="right-column">
          <button><a href="Personal/nurseview.php">Recept</a></button>
          <button><a href="Personal/klagomal_personal.php">Omdöme</a></button>
      </div>
      </div>
